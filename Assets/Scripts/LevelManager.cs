...
public class LevelManager : MonoBehaviour
{
    ...
    void LevelSetup()
    {
        ...
        // instantiate walls
        // this currently is an array of wall prefabs
        ...
        //TODO: build one wall prefab and then spawn clones at the above settings programmatically
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            outerWallClone = Instantiate(outerWallPrefab, outerWallPrefab.transform.position, Quaternion.Euler(rotate)) as GameObject;
        ...
        for (int x = -10; x < 10; x++)
        {
            for (int y = -10; y < 10; y++)
            {
                //Instantiate the GameObject instance using the prefab chosen for toInstantiate at the Vector3 corresponding to current position cast it to GameObject.
                pickUpClone =
                    Instantiate(pickUpPrefab, new Vector3(x, y, 0f), Quaternion.identity) as GameObject;
